      ...
      builder: (context, state) {
        ...
        if(firstTime){
          return Conditional.single(
              context: context,
              conditionBuilder: (context)=> cubit.popularMovies.length!=0,
                      ...
                      children: [
                            ...
                            child: ListView.separated(
                              itemBuilder: (context, index)=> InkWell(
                                onTap: (){
                                  ...
                                  cubit.getPopularMovies(selectedPage);
                                  firstTime = false;
                                },
                                child: Container(
                        ...
                        GridView.count(
                          ...
                          children: List.generate(
                              cubit.popularMovies.length,
                                  (index) =>
                                  buildGridMovie(cubit.popularMovies[index], context)),
